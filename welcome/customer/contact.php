...
<body>
	...
	<header class="container">
		<div class="row">
			<div class="col-md-4">
				<div id="logo">Mock Supermarket</div>
			</div>
			<div class="col-md-4">
			...
			<div class="col-md-4">
				<div id="cart"><a class="btn btn-1" href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span>CART : 0 ITEM</a></div>
			</div>
		</div>
	</header>
	<!--Navigation-->
						...
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="category.php">Window</a></li>
									<li><a href="category.php">MacBook</a></li>
								</ul>
							</div>
						</div>
					</li>
						...
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									...
									<li><a href="category.php">Acer</a></li>
								</ul>
							</div> 
						</div>
					</li>
						...
						<div class="dropdown-menu" style="margin-left: -203.625px;">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									...
									<li><a href="category.php">Lenovo</a></li>
									<li><a href="category.php">Google</a></li>
								</ul>
								<ul class="list-unstyled">
									<li><a href="category.php">Nexus</a></li>
									<li><a href="category.php">Dell</a></li>
									<li><a href="category.php">Oppo</a></li>
									<li><a href="category.php">Blackberry</a></li>
									<li><a href="category.php">HTC</a></li>
								</ul>
								<ul class="list-unstyled">
									<li><a href="category.php">LG</a></li>
									<li><a href="category.php">Q-Mobiles</a></li>
									<li><a href="category.php">Sony</a></li>
									<li><a href="category.php">Wiko</a></li>
									<li><a href="category.php">T&T</a></li>
								</ul>
							</div>
						</div>
					</li>
