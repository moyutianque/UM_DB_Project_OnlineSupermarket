<?php
	...
	$searchContent = $_GET['searchContect'];
	/*echo "<script type='text/javascript'>alert('$category');</script>";*/


	$query = "SELECT * FROM Goods WHERE Gname LIKE'%".$searchContent."%' ORDER BY Price LIMIT 9 lock in share mode;";
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						<li>Home</li>
						<li>Search : <?php echo $searchContent;?></li>
					</ul>
				</div>
			</div>
			<div class="row">
